 ...
 * @description  广告滑动页的第三个页面
 */
public class PageThreeFragment extends BaseFragment implements OnClickListener{
	...
	protected void initialized() {
		if (ValueUtil.isListEmpty(alleylists)) {
			...
			content.setText("      "+alleylists.get(0).getContent());
			ImageCacheUitl.displayNormalImageView(pagerview,alleylists.get(0).getImg(), R.id.pagerview);
		}
	}
	@Override
